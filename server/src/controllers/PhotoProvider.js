...
class PhotoProvider {
  async getPhotos (req, res) {
    ...
    const [err, result] = await to(axios.get(`${BASE_URL}/?method=flickr.photos.getRecent&api_key=${API_KEY}&text=${term}&page=${page}&extras=owner_name&format=json&nojsoncallback=1&per_page=12`))
